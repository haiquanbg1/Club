    ...
    return (
        <div>
            ...
            <div className=" flex 2xl:w-1/2 w-full bg-gray-600 p-2">
                <input value={id} className="flex h-10 w-full rounded-md bg-transparent mr-2 border-none outline-none" placeholder="Nhập id người dùng" onChange={handleInputChange} ></input>
